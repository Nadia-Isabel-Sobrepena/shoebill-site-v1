...
// List of image URLs (placeholders) and facts
// NOTE: You need to replace these placeholder URLs with actual image links!
...
function showNext() {
    // Increment the index, and wrap around to 0 if it goes past the last item
